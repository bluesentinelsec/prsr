...
def render_diff(
    ...
    return render(parsed, source=source, color=color)


def render_pr(pr: str, repo: Optional[str] = None, color: bool = False) -> str:
...
def render_commit(sha: str, repo: Optional[str] = None, color: bool = False) -> str:
